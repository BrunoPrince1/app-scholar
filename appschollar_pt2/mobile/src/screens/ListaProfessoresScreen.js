...
export default function ListaProfessoresScreen() {
  ...
  const abrirEdicao = (prof) => {
    ...
    setForm({
      ...
      area: prof.area || '',
      tempo_docencia: prof.tempo_docencia?.toString() || '',
      email: prof.email || '',
    });
  ...
  const salvarEdicao = async () => {
    ...
    setSalvando(true);
    try {
      await atualizarProfessor(profEditando.id, {
        ...form,
    ...
    <View style={styles.card}>
      <View style={styles.cardHeader}>
        ...
        <View style={styles.cardInfo}>
          ...
          {item.tempo_docencia ? (
            <Text style={styles.cardSub}>🕐 {item.tempo_docencia} anos de docência</Text>
          ) : null}
        </View>
      </View>
    ...
    <View style={styles.screen}>
      <View style={styles.searchBar}>
        <TextInput
          ...
          placeholder="🔍  Buscar por nome, área, titulação..."
          value={busca}
                ...
                <View style={styles.dropdown}>
                  {TITULACOES.map((t) => (
                    <TouchableOpacity
                      ...
                      onPress={() => { handleChange('titulacao', t); setMostrarTitulacoes(false); }}
                    >
                      <Text>{t}</Text>
                    </TouchableOpacity>
                  ))}
