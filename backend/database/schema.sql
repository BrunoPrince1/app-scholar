...
--  Execute: psql -U postgres -f database/schema.sql
-- ============================================================
...
CREATE TABLE IF NOT EXISTS usuarios (
  ...
  perfil VARCHAR(20) NOT NULL DEFAULT 'aluno',  -- 'aluno' | 'professor' | 'admin'
...
-- ──────────────────────────────────────────────────────────
--  Dados de seed (para teste inicial)
-- ──────────────────────────────────────────────────────────
...
VALUES (1, 1, 8.5, 9.0, 8.75, 'Aprovado')
ON CONFLICT DO NOTHING;
